class Pokeman {
  ...
  Pokeman.fromJson(Map<String, dynamic> json) {
...
class PokemanListData {
  int? count;
  String? next;
  String? previous;
  List<PokemanListResult>? results;

  PokemanListData({this.count, this.next, this.previous, this.results});

  PokemanListData.fromJson(Map<String, dynamic> json) {
    count = json['count'];
    next = json['next'];
    previous = json['previous'];

    if (json['results'] != null) {
      results = <PokemanListResult>[];
      json['results'].forEach((v) {
        results!.add(PokemanListResult.fromJson(v));
      });
    }
  }
  ...
  PokemanListData copyWith({
    int? count,
    String? next,
    String? previous,
    List<PokemanListResult>? results,
  }) {
    return PokemanListData(
...
class PokemanListResult {
  String? name;
  String? url;

  PokemanListResult({this.name, this.url});

  PokemanListResult.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    url = json['url'];
  }
...
class Sprites {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['back_shiny_female'] = backFemale;
